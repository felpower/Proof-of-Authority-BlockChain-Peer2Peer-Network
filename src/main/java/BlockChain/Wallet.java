...
public class Wallet {
  ...
  //The PrivateKey is used to sign transactions
  ...
  /*
  Used the Elliptic-curve cryptography: https://en.wikipedia.org/wiki/Elliptic-curve_cryptography
  ...
  public float getBalance() {
    float total = 0;
    for (Map.Entry<String, TransactionOutput> item : FelCoin.UTXOs.entrySet()) {
