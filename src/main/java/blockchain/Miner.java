...
public class Miner {
  ...
  public static Block mineNewBlock(Wallet wallet, Blockchain blockchain) {
    ...
    return new Block(header, Collections.emptyList(), new SignaturePublicKey(wallet.signKey(header), wallet.getKeyPair().getPublic()));//ToDo: Merkle Root and List of Transactions
  }
}
